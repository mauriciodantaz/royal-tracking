...
- Event log origin column shows the generating platform (Snippet, RD Station CRM, Pipedrive, …). `/dashboard/eventos` paginates the full history (50 per page).
...
- White-label opcional via PLATFORM_NAME (#56)

## [0.12.0] - 2026-08-03

### Changed

- Captura de leads, agrupamento de forms ecommerce e toggle de funil CRM (#54)

## [0.11.1] - 2026-07-24

### Changed

- fix: mask secrets, form query fingerprint, disable Ads temporarily (#52)

## [0.11.0] - 2026-07-24

### Changed

- feat(snippet): descoberta, regras e painel Regras simplificado (#50)
